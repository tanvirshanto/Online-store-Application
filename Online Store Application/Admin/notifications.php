            ...
            <div class="box round first grid">
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("select * from customer_contact",$link)or die(mysql_error);
                   ...
                   while($row=mysql_fetch_array($res))
				   {
					...
					<td><h6><?php  echo $cfname ;?></h6> </td>
					<td><h6><?php  echo $clname ;?></h6> </td>
					<td><h6><?php  echo $cemail ;?></h6>  </td>
					<td><h6><?php  echo $csubject; ?> </h6> </td>
					<td><h6> <?php  echo $cmessage; ?></h6> </td>
					<td><h6> <?php  echo $post; ?></h6> </td>
