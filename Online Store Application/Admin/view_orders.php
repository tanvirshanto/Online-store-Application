                            ...
                            <ul class="submenu">
                               <li><a href="add_product.php"><h5>Add Products<h5></a> </li>
                                <li><a href="product_view.php"><h5> View Products</h5></a> </li>
								 <li> <a href=""><h5>View Orders<h5></a> </li>
        ...
        <div class="grid_10">
            <div class="box round first grid">
                <h2>
                    ...
                    <table width="1050" align="center" border="1px"  cellspacing="50px">
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("select * from orders",$link)or die(mysql_error);
                   ...
                   while($row=mysql_fetch_array($res))
				   {
					...
					<td><h6><a href="order_delete.php?delete_id=<?php  echo $cname; ?>" style="color: rgb(51,51,255)">  Delete </a> </h6></td>
					<td><h6><a href="orders_approve.php?approve_id=<?php  echo $cname; ?>" style="color: rgb(51,51,255)">  Approve </a> </h6></td>
