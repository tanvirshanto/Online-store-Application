...
<body>
  ...
  <div class="dropdown-content">
   <?php
				   ...
				   $res=mysql_query("select product_name from views",$link)or die(mysql_error());
				 ...
				 ?>
                <a href="product_hits.php?pname=<?php echo $row['product_name']?>"> <?php echo $row['product_name']?></a>
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("SELECT * FROM views where product_name='".$proname."'",$link)or die(mysql_error);
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("SELECT * FROM views ORDER BY Hits DESC",$link)or die(mysql_error);
