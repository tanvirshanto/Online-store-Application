...
#submission {
 clear:both;position:relative;left:200px;
            ...
            <div class="box round first grid">
              ...
              <option value="Furniture">Furniture</option>
                <option value="Fashion">Fashion</option>
				 ...
				 <td><input type="text" name="price" value="<?php  echo $ppr; ?>"></td>
				 </tr>
				 
				 <tr>
				 <td><h5>Product Quantity </h5> </td>
				 <td><input type="text" name="quantity" value="<?php  echo $pq ;?>"></td>
				 </tr>
				 
				 
				 <tr>
				 <td><h5>Product Image</h5></td>
				 <td><input type="file" name="image" ><img src="<?php  echo $ppic ;?>" width="70px" height="70px"></td>
				 </tr>
              ...
              <option value="<?php echo $row['subcat_name']?>"><?php echo $row['subcat_name']?></option>
				 ...
				 <td><input type="text" name="ptext" value="<?php  echo $pdes; ?> "></td>
				 </tr>
				 	
				  </table>
				  
			     <p id="submission"><input type="submit" name="submit1" value="Update Products"></p>
...
$res=mysql_query("UPDATE products SET quantity='$_POST[quantity]',price='$_POST[price]',description='$_POST[ptext]',subcat_name='$_POST[sub_category]',img_loc='$filepath' WHERE product_id='".$update_id."'",$link)or die(mysql_error());
