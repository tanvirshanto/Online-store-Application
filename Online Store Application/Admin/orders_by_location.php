            ...
            <div class="box round first grid">
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("SELECT count(o.order_id) 'TOTAL_ORDERS', u.Address FROM orders o, users u where o.customer_name=u.Username GROUP BY u.Address ORDER BY count(o.order_id) DESC",$link)or die(mysql_error);
                   ...
                   while($row=mysql_fetch_array($res))
				   {
					...
					<td><h6><?php  echo $orders ;?></h6>  </td>
					<td><h6><?php  echo $location ;?></h6>  </td>
