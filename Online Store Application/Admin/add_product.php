        ...
        <div class="grid_10">
            <div class="box round first grid">
              ...
              <option value="<?php echo $row['subcat_name']?>"><?php echo $row['subcat_name']?></option>
                ...
                <option value="saab">DINNER TABLE</option>
                ...
                <option value="DRAWER">DRAWER</option>
				 ...
				 <td><input type="text" name="ptext" required></td>
				 </tr>
				 	
				  </table>
				  
			     <p id="submission"><input type="submit" name="submit1" value="Add Products"></p>
...
if(isset($_POST['submit1']))
{
	...
	$link = mysql_connect('localhost', 'root', '') or die('Connection error');
mysql_select_db("letsshop");
$res=mysql_query("INSERT INTO products(quantity, price, description, subcat_name, img_loc) VALUES ('$_POST[quantity]','$_POST[price]','$_POST[ptext]','$_POST[sub_category]','$filepath')",$link)or die(mysql_error());
