                ...
                <div class="block" id="section-menu">
                    <ul class="section menu">
                        ...
                        <li><a class="menuitem">Orders</a>
                            <ul class="submenu">
                                <li> <a href=""><h4>View Orders<h4></a> </li>
                                 <li><a href="customer_view.php"><h4>View Customer<h4> </li>
                        ...
                        <li><a class="menuitem">Admin</a>
                            <ul class="submenu">
                                <li><a href=""><h4>Add Admin<h4></li> 
                               <li><a href=""><h4>View Admin info<h4></li> 
            ...
            <div class="box round first grid">
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("select sum(`total_amount`), `customer_name` FROM orders GROUP by `customer_name` order by sum(`total_amount`) DESC",$link)or die(mysql_error);
