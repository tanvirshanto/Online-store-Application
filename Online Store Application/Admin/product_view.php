...
<body>
  ...
  <div class="dropdown-content">
   <?php
				   ...
				   $res=mysql_query("SELECT `subcat_name` FROM `sub-category`",$link)or die(mysql_error());
				 ...
				 ?>
                <a href="product_view.php?subname=<?php echo $row['subcat_name']?>"> <?php echo $row['subcat_name']?></a>
...
if(isset($_GET['subname']))
	
	{
		...
		<table width="1050" align="center" border="1px">  <!--- onload table data view -->
					...
					<th><h4>Subcat Name</h4></th>
					<th><h4>Image</h4></th>
					<th colspan="2"><h4>Customize</h4></th>
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("select * from products where subcat_name='".$name."'",$link)or die(mysql_error);
                   ...
                   while($row=mysql_fetch_array($res))
				   {
					...
					<td><h6><?php  echo $pid ;?></h6> </td>
					<td><h6><?php  echo $pq ;?></h6>  </td>
					<td><h6><?php  echo $ppr; ?> </h6> </td>
					<td><h6> <?php  echo $pdes; ?></h6> </td>
					<td><h6><?php  echo $pname; ?></h6>  </td>
					<td><h6><img src="<?php  echo $ppic ;?>" width="60px" height="70px"></h6> </td>
					<td><h6><a href="update_product.php?edit_id=<?php  echo $pid; ?>" style="color: rgb(51,51,255)" >  Edit </a> </h6></td>
					<td><h6><a href="delete_product.php?delete_id=<?php  echo $pid; ?>" style="color: rgb(51,51,255)">  Delete </a> </h6></td>
	...
	<?php } ?>
              ...
              $link = mysql_connect('localhost', 'root', '') or die('Connection error');
                 mysql_select_db("letsshop");
                  ...
                  $res=mysql_query("select * from products",$link)or die(mysql_error);
