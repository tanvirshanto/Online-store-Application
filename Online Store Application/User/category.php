...
$name=$_GET['u'];
$sql="SELECT * FROM products Where subcat_name='".$name."'";
if ($result=mysql_query($sql))
  {
  while ($fieldinfo=mysql_fetch_array($result,MYSQL_ASSOC))
    {  
	  //print_r($fieldinfo['price']);
                ...
                <div class="col-md-9">
                   ...
                   <?php
					  ...
					  foreach($rows as $fieldinfo)
					  {
						...
						$pro_id=stripslashes($fieldinfo['product_id']);
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.php?u='<?php echo $pro_id ?>'&v='<?php echo $name ?>'">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php?u='<?php echo $pro_id ?>'&v='<?php echo $name ?>'"><?php print $desc; ?></a></h3>
                                    <p class="price"><?php print 'Tk '.$price.' /-'; ?></p>
									
                                    <p class="buttons">
                                       <a href="detail.php?u=<?php echo $pro_id ?>&v=<?php echo $name?>" class="btn btn-default">View detail</a>
									   
									  
	                                 
									   
                                        <a href="detail.php?u=<?php echo $pro_id ?>&v=<?php echo $name?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
