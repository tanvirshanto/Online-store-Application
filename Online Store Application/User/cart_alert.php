    ...
    <div id="top">
        <div class="container">
            <div class="col-md-6 offer" data-animate="fadeInDown">
                <a href="index.html" class="btn btn-success btn-sm" data-animate-hover="shake">LET'S SHOP</a>  
            </div>
        ...
        <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="Login" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
					...
					<?php  $id=$_GET['u'];?>
                        <form method="post" action="cart_login.php?u=<?php echo $id ?>">
    ...
    <div id="all">
        ...
        <div id="content">
            ...
            <div class="col-md-5" data-animate="fadeInDown">
                    ...
                    <li><h4><a href="#" data-toggle="modal" data-target="#login-modal">Login</h4></a>
                    </li>
                                ...
                                <p class="buttons"><a href="register.html" class="btn btn-primary"><i class="fa fa-home"></i> Don't Have an Account?</a>
                                </p>
                            </div>
                        </div>
                    </div>
