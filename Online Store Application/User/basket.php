...
if ($_SESSION["inf"]=="")
 {
  ...
  header("Location:cart_alert.php?u=".$id);
		...
		<div id="content">
            <div class="container">
				...
				<div class="col-md-9" id="basket">
					...
					<form method="post" action="checkout4.php?u=<?php echo $id ?>" >
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="2"><?php  echo 'Tk '.$price.' /-';?></th>
                                        </tr>
                                    </tfoot>
                                </table>
								<?php } ?>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-primary">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
